    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div> <img src="/Nero_Computers/assets/logo.jpg" style="height:80px; width:80px"></div>
                ...
                <div>
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/Nero_Computers/JSPS/cartView.jsp"><i class="fas fa-shopping-cart"></i> Cart</a>
                        </li>
                        <li class="nav-item">
